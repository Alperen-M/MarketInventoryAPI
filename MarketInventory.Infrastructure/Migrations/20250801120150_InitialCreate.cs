        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Kullanicilar_Kullanicilar_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Birimler_Kullanicilar_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Kullanicilar",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Urunler_Kullanicilar_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Kullanicilar",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Barkodlar_Kullanicilar_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Kullanicilar",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StokHareketleri_Kullanicilar_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Kullanicilar",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UrunFiyatlar_Kullanicilar_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Kullanicilar",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Barkodlar_CreatedByUserId",
                table: "Barkodlar",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Birimler_CreatedByUserId",
                table: "Birimler",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Kullanicilar_CreatedByUserId",
                table: "Kullanicilar",
                column: "CreatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StokHareketleri_CreatedByUserId",
                table: "StokHareketleri",
                column: "CreatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UrunFiyatlar_CreatedByUserId",
                table: "UrunFiyatlar",
                column: "CreatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Urunler_CreatedByUserId",
                table: "Urunler",
                column: "CreatedByUserId");
        }
